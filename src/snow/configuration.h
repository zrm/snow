...
MAKE_CONF_TYPE(conf_string, std::string, ss_convert<std::string>, CONFIG_FILE, KEY_FILE, CERT_FILE, KNOWN_PEERS_FILE, DH_PARAMS_FILE,\
			   CLONE_DEVICE, VIRTUAL_INTERFACE, NATPOOL_NETWORK, ADDRESS_ASSIGNMENT_FILE, PERMANENT_ADDRESS_ASSIGNMENT_FILE, SNOW_USER)
...
MAKE_CONF_TYPE(conf_bool, bool, ss_convert<bool>, DHT_RFC1918_ADDRESSES, DHT_LINK_LOCAL_ADDRESSES, NEVER_TRUST_PEER_VISIBLE_IPADDRS)
